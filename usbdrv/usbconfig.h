 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdb, 0x27 /* 0x27db = free PID for USB Keyboards */
 ...
 */
#define USB_CFG_VENDOR_NAME     'C', 'h', 'r', 'i', 's', 't', 'o', 'p', 'h', 'e', 'r', 'b', 'i', 'r', 'd', '.','c', 'o', '.', 'u', 'k'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME   'A', 'r','c', 'a', 'd', 'e', ' ', 'C', 'o', 'n', 't', 'r', 'o', 'l', 'e', 'r'
